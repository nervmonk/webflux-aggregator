...
class CustomerInformationTest extends AbstractIntegrationTest {
    ...
    private final Logger log = LoggerFactory.getLogger(CustomerInformationTest.class);
    ...
    private void mockCustomerInformation(String path, int responseCode) {
        ...
        mockServerClient
                ...
                .respond(HttpResponse.response(responseBody).withStatusCode(responseCode)
                        .withContentType(MediaType.APPLICATION_JSON));
    }

    private BodyContentSpec getCustomerInformation(HttpStatus expectedStatus) {
